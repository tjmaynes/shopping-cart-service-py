...
class TestApp:
    ...
    def test_health_endpoint_returns_200_when_db_conn_is_connected(
    ...
    def test_cart_index_returns_items_from_cart(
    ...
    def test_cart_get_item_by_id_returns_item(
        self, client: TestClient, default_cart_item: Dict
    ):
    ...
    def test_cart_update_item_returns_item(
        self, client: TestClient, default_cart_item: Dict
    ):
        _, added_item = self.__add_item(client, default_cart_item)
    ...
    def test_cart_delete_item_returns_id(
        self, client: TestClient, default_cart_item: Dict
    ):
